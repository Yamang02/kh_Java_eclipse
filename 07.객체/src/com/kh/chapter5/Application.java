...
//		methodTest.method6({2, 3, 4});  에러발생
		methodTest.method6(new int[] {2, 3, 4});

		System.out.println();
		
//		methodTest.method6(1, 2, 3);
//		methodTest.method6(1, 2);
//		methodTest.method6(1);
...
//		methodTest.method7();
		...
		// 2. 매개변수가 없고 반환값이 있는 메소드 추출
		System.out.println(C_StaticMethod.method2());
		
		
		// 3. 매개변수가 있고 반환값이 없는 메소드 추출
		...
		System.out.println(C_StaticMethod.method4(8, 9, 20));
	}
}
