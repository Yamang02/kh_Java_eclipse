 ...
 *   - 반환형이 존재하지 않는다.
 *   - 매개변수가 있는 생성자를 작성하게 되면 기본 생성자를 자동으로 만들어주지 않는다.
 */
...
public class User {
	...
	/*
	 * 기본 생성자 - 객체 생성만을 목적으로 사용된다. - 기본 생성자를 생략하는 경우, 자동으로 만들어줬기 때문에 항상 객체 생성이 가능했다.
	 * 
	 */
	 ...
	 * 객체 생성과 동시에 전달된 값들을 매개변수를 받아서 필드를 초기화하는 목적으로 사용된다.
	 * 
	 */
...
//		this.password = password;
//		this.name = name;
		this(id, password, name); // 항상 최상위에 있어야 한다. , 생성자 호출은 생성자 호출에서만 사용해야 한다.
		this.age = age;
		this.gender = gender;
	}
