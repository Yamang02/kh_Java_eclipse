...
import com.kh.inherit.after.Televison;
...
//		SmartPhone smartPhone = new SmartPhone("KT");
		

		// Television 인스턴스 생성
		Televison televison = new Televison("엘지", "t-01", "벽걸이 TV", 2000000, 40);
		...
		Book book3 = new Book("자바 너무 어려워 ", "문인수", 4000);
